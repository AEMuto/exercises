...
var valid2 = [5, 5, 3, 5, 7, 6, 6, 7, 6, 8, 7, 5, 1, 4, 3, 9];
var valid3 = [3, 7, 1, 6, 1, 2, 0, 1, 9, 9, 8, 5, 2, 3, 6];
var valid4 = [6, 0, 1, 1, 1, 4, 4, 3, 4, 0, 6, 8, 2, 9, 0, 5];
var valid5 = [4, 5, 3, 9, 4, 0, 4, 9, 6, 7, 8, 6, 9, 6, 6, 6];

// All invalid credit card numbers
var invalid1 = [4, 5, 3, 2, 7, 7, 8, 7, 7, 1, 0, 9, 1, 7, 9, 5];
var invalid2 = [5, 7, 9, 5, 5, 9, 3, 3, 9, 2, 1, 3, 4, 6, 4, 3];
var invalid3 = [3, 7, 5, 7, 9, 6, 0, 8, 4, 4, 5, 9, 9, 1, 4];
var invalid4 = [6, 0, 1, 1, 1, 2, 7, 9, 6, 1, 7, 7, 7, 9, 3, 5];
var invalid5 = [5, 3, 8, 2, 0, 1, 9, 7, 7, 2, 8, 8, 3, 8, 5, 4];

// Can be either valid or invalid
var mystery1 = [3, 4, 4, 8, 0, 1, 9, 6, 8, 3, 0, 5, 4, 1, 4];
var mystery2 = [5, 4, 6, 6, 1, 0, 0, 8, 6, 1, 6, 2, 0, 2, 3, 9];
var mystery3 = [6, 0, 1, 1, 3, 7, 7, 0, 2, 0, 9, 6, 2, 6, 5, 6, 2, 0, 3];
var mystery4 = [4, 9, 2, 9, 8, 7, 7, 1, 6, 9, 2, 1, 7, 0, 9, 3];
var mystery5 = [4, 9, 1, 3, 5, 4, 0, 4, 6, 3, 0, 7, 2, 5, 2, 3];
...
var validateCred = function validateCred(array) {
    var total = 0;
    var checkNum = array[array.length - 1];
    // console.log(checkNum);
    var slicedArray = array.slice(0, array.length - 1);
    // let correctedArray = slicedArray;
    var reversedArray = slicedArray.reverse();
...
batch.forEach(function (a) {
    return console.log(validateCred(a));
});

var findInvalidCards = function findInvalidCards(card) {
    var invalidCards = [];
    invalidCards = card.filter(function (a) {
        return validateCred(a) !== true;
    });
    return invalidCards;
};
...
var idInvalidCardCompanies = function idInvalidCardCompanies(card) {
    var companies = [];
    ...
    }return [].concat(_toConsumableArray(new Set(companies.sort())));
};
...
var testCard = '4539689887705798';

var returnToArray = function returnToArray(x) {
    var array = [];
...
var correctedCred = function correctedCred(card) {
    var invalidCards = [];
    invalidCards = card.filter(function (a) {
        return validateCred(a) !== true;
    });
