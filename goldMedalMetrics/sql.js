...
const numberMenMedalists = (country) => {
  return `SELECT gender, COUNT(*) AS count FROM GoldMedal WHERE country = '${country}' AND gender = 'Men'`;
};
...
const numberWomenMedalists = (country) => {
  return `SELECT gender, COUNT(*) AS count FROM GoldMedal WHERE country = '${country}' AND gender = 'Women'`;
};
